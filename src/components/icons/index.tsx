...
export function MoreHorizontalIcon({ className = "w-4.5 h-4.5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function RestoreIcon({ className = "w-4.5 h-4.5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function ClaudeIcon({ className = "w-4.5 h-4.5 text-text-muted" }: IconProps) {
  return (
...
export function CodexIcon({ className = "w-4.5 h-4.5 text-text-muted" }: IconProps) {
  return (
