# Runa - Development Guide

## Project Overview

Runa is a cross-platform markdown note-taking app for macOS, Windows, and Linux, built with Tauri v2 (Rust backend) + React/TypeScript/Tailwind (frontend) + TipTap (WYSIWYG editor) + Tantivy (full-text search).
...
- Endpoint: `https://github.com/brenogonzaga/runa/releases/latest/download/latest.json`
...
- **Per-folder settings**: `{NOTES_FOLDER}/.runa/settings.json`
